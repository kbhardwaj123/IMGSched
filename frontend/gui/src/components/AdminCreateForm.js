...
class AdminCreationForm extends React.Component {
    ...
    componentWillReceiveProps(newProps) {
        ...
        const data = {
            ...
            admin_password: this.inputPassword3.current.value,
    ...
    handleFormSubmit = (event, requestType) => {
        ...
        const enroll1 = this.inputEnroll.current.value;
        ...
        const admin_password1 = this.inputPassword3.current.value;
        if(password1===confirm_password1) {
            this.props.onAuth(username1, email1, password1, confirm_password1, admin_password1, enroll1);
        }
        ...
        return(
            <fieldset>
                <Form onSubmit={(event) => this.handleFormSubmit(event,this.props.requestType)}>
                    ...
                    <Form.Group controlId="formBasicPassword">
                        <Form.Label>Admin Creation Password</Form.Label>
                        <Form.Control ref={this.inputPassword3} onChange={()=> this.handleChangeConfirmPassword()} type="password" placeholder="Confirm Password" />    
                    </Form.Group>
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminCreationForm);